...
public class BotonFinal : MonoBehaviour
{
    ...
    // Variable para vincular el objeto de las raices
    [SerializeField] private GameObject raices;
    [SerializeField] private GameObject raicesDiag;
